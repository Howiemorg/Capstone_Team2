...
function get_available_intervals(events, circadian_rhythm, startDate, curr_day) {
...
const algorithm = (
  ...
  for (let i = 0; i < 7; ++i) {
    ...
    const free_time = get_available_intervals(daily_events, circadian_rhythm, startDate, curr_day);
