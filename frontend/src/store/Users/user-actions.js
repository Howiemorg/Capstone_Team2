    ...
    return async (dispatch) => {
        ...
        try {
            ...
            const response = await axios.post(
                `https://capstone-backend-charles-tran.vercel.app/register-user?user_first_name=${body.firstname}&user_last_name=${body.lastname}&user_email=${body.username}&user_password=${body.password}&wake_time='${body.newWakeTime}'&sleep_time='${body.newSleepTime}'`
            );
